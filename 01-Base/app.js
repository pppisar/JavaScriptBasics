// Переменньіе и базовьіе операции
// Переменная - let | константа const
let num = 12; // number
...
// alert блокирует загрузку страницьі
// alert("You are is " + surname + ' ' + firstName);

// surname = 'Samarsky' // ok - изменяем let
// firstName = 'Ivan' // error - Изменение const
